  ...
  return <Card className="mt-4">
    ...
    <CardContent>
      <Tabs defaultValue="devices">
        <TabsList className="grid w-full grid-cols-3"><TabsTrigger value="devices"><Wifi size={15} className="me-2" />{ar ? 'الأجهزة' : 'Devices'}</TabsTrigger><TabsTrigger value="mapping">{ar ? 'ربط الموظفين' : 'Employee Mapping'}</TabsTrigger><TabsTrigger value="rules"><Settings2 size={15} className="me-2" />{ar ? 'المعادلات' : 'Rules'}</TabsTrigger></TabsList>
