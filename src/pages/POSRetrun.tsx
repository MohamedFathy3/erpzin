...
const POS: React.FC = () => {
  ...
  // ✅ التعديل: إضافة معالج لتحديث shift
  const handleShiftChange = useCallback((shift: any) => {
    console.log('🔄 POSShiftManagement sending shift to parent:', currentShift);
  ...
  return (
    <TooltipProvider delayDuration={300}>
      <div className="h-screen flex flex-col bg-background overflow-hidden">
        ...
        {/* ✅ التعديل: Shift Management with handleShiftChange */}
