...
export default function WarehouseReports() {
  ...
  const movementQuery = useQuery({
    ...
    queryFn: async () => {
      ...
      return (await api.get<{ data: Movement[] }>('/reports/warehouse-movements', { params: { filters, perPage: 500 } })).data.data;
    },
  });
