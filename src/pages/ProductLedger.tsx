...
interface LedgerRow { id: number; date?: string; reference?: string | number; quantity?: number; unit_price?: number; total?: number; type?: string; note?: string; variant?: { product_unit_id?: number | null; size?: string | null; color_id?: number | null; color?: string | null }; customer?: { name?: string; name_ar?: string; phone?: string }; supplier?: { name?: string; name_ar?: string; phone?: string }; warehouse?: { name?: string }; }
