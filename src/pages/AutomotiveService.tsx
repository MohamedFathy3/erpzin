...
const AutomotiveServicePage = () => {
  ...
  const createCustomerAccount = async () => {
    ...
    try {
      await automotiveApi.createCustomerAccount(portalForm); setPortalForm({ customer_id: 0, email: '', password: '' }); toast.success('تم إنشاء دخول العميل للبوابة');
